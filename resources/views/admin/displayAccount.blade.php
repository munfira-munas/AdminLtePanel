...
@section('title', 'Display Account')

@section('pageHeading', 'Display Account')
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">&nbsp;</div>
             <div class="col-md-6">
                  <label class="control-label h2" style="font-family:copperplate;color:navy;">{{Str::upper($Info->first_name)}}&nbsp;{{Str::upper($Info->last_name)}}</label>
              </div>
